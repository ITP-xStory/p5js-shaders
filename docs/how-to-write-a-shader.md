...
Then we make something called **attributes**, these contain information that is automatically sent to the shader by the p5 sketch. [More on attributes.](https://itp-xstory.github.io/p5js-shaders/#/./docs/using-variable-qualifiers?id=variable-qualifiers-using-attributes)
